...
- Rate limiting terdistribusi belum tersedia pada infrastruktur sekarang. Jangan menggantinya dengan counter memory pada Next.js atau GAS karena lifecycle serverless membuat hasilnya tidak andal.
- Registry Next.js di-cache selama lima menit. Saat rotasi secret tenant, deploy perubahan terkoordinasi atau tunggu cache lama kedaluwarsa sebelum mencabut secret lama.
